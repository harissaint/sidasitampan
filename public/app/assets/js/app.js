                ...
                var e = window.location,
                    o = $(".metismenu li a")
                        .filter(function () {
                            ...
                            let url = e.href.split("/");
                            let lastPart = url[url.length - 1];
                            // split ? from last part
                            lastPart = lastPart.split("?")[0];
                            
                            // get last part of href
                            url = this.href.split("/");
                            let lastPartHref = url[url.length - 1];

                            // check if last part of url is equal to last part of href
                            return lastPartHref == lastPart;
                        })
                        .addClass("")
                        .parent()
                        .addClass("mm-active");
