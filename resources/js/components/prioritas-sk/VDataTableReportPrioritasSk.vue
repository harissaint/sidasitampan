<template>
    <div class="mb-3">
        <h6>Report Detail Data Master Prioritas</h6>
...
const columns = [{
    ...
    title: 'Sub Kegiatan',
    render: function (data, type, row, meta) {
        return row.kode_sub_kegiatan + ' - ' + row.nama_sub_kegiatan;
    },
}, {
    data: 'kode_akun',
    title: 'Rekening',
    render: function (data, type, row, meta) {
        return row.kode_akun + ' - ' + row.nama_akun;
    },
}, {
    data: 'nilai_rincian',
    title: 'Anggaran',
...
export default {
    ...
    data() {
        return {
            ...
            options: {
                ...
                processing: false,
                serverSide: false,
                ajax: route('master.prioritas-sk.report', this.prioritas_id),
                scrollCollapse: true,
                scrollX: true,
    ...
    methods: {
        submitData() {
            ...
            // set options ajax
            this.options.ajax = {
                url: route('master.prioritas-sk.report', this.prioritas_id),
                type: 'GET',
                data: {
