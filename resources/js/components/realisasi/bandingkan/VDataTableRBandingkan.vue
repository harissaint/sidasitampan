    ...
    <div class="mb-3">
        ...
        <form class="row g-2">
            ...
            <!-- <div class="col-md-6 form-group">
                ...
                <input type="number" class="form-control" id="tahun" v-model="tahun" @change="filterTahapan(tahun)" required>
            </div> -->
...
export default {
    ...
    data() {
        return {
            ...
            options: {
                ...
                processing: false,
                serverSide: false,
                ajax: route('master.realisasi.bandingkan'),
                scrollCollapse: true,
                scrollX: true,
    ...
    methods: {
        submitData() {
            ...
            this.options.ajax = {
                url: route('master.realisasi.bandingkan'),
                type: 'GET',
                data: {
                    // tahun: this.tahun,
        ...
        filterTahapan($tahun) {
            this.tahapan_id = '';
            // hide all options
            $('#tahapan_id option').hide();
            // show only options with class $tahun
            $('#tahapan_id option.' + $tahun).show();
        },
    },
}
