        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('master.prioritas-sk.index') }}">Prioritas - Sub Kegiatan</a></li>
...
@section('content')
    <div id="app">
        <div class="card">
            <div class="card-body">
                <v-data-table-report-prioritas-sk group="{{ Auth::user()->group->nama }}"
                    skpd_nama="{{ Auth::user()->skpd?->nama }}"
                    prioritas_id="{{ $prioritas->id }}">
                </v-data-table-report-prioritas-sk>
            </div>
        </div>
    </div>
@endsection
