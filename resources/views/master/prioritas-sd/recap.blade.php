        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('master.prioritas-sd.index') }}">Prioritas - Sumber Dana</a></li>
...
@section('content')
    <div id="app">
        <div class="card">
            <div class="card-body">
                <v-data-table-recap-prioritas-sd group="{{ Auth::user()->group->nama }}"
                    skpd_nama="{{ Auth::user()->skpd?->nama }}"
                    prioritas_id="{{ $prioritas->id }}">
                </v-data-table-recap-prioritas-sd>
            </div>
        </div>
    </div>
@endsection
